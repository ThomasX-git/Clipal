...
- **Added Codex OAuth usage tracking and plan display**, showing real-time usage limits and plan information in the Web UI.
...
- **Added: Codex OAuth usage tracking with plan type detection from JWT tokens**
- **Added: Usage API client for fetching real-time rate limits and usage data**
- **Added: Web API endpoint for OAuth metadata retrieval (/api/oauth/metadata)**
- **Added: Web UI enhancements displaying OAuth plan and rate limit information**
- **Added: Comprehensive tests for usage tracking functionality**
...
- **新增 Codex OAuth 使用跟踪和计划显示**，在 Web UI 中实时显示使用限制和计划信息。
...
- **新增：Codex OAuth 使用跟踪，从 JWT 令牌中检测计划类型**
- **新增：使用 API 客户端，用于获取实时速率限制和使用数据**
- **新增：OAuth 元数据检索 Web API 端点 (/api/oauth/metadata)**
- **新增：Web UI 增强，显示 OAuth 计划和速率限制信息**
- **新增：使用跟踪功能的全面测试**
